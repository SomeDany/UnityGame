...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor(){
        ...
        if(drawMode == DrawMode.NoiseMap){
            ...
            display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapData.heightMap, meshHeightMultiplier, meshHeightCurve, editorPreviewLOD), TextureGeneration.TextureFromColourMap(mapData.colourMap, mapChunkSize, mapChunkSize));
        }
        else if(drawMode == DrawMode.FallofMap){
            display.DrawTexture(TextureGeneration.TextureFromHeightMap(FallofGenerator.GenerateFallofMap(mapChunkSize)));
        }
    }
